...
/* harmony export */ });
/* harmony import */ var _validation_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./validation.js */ "./src/scripts/validation.js");
        ...
        case 7:
          ...
          if (data.status === "success") {
            ...
            Object.keys(data.fields).forEach(function (field) {
              ...
              if (inputElement) {
                (0,_validation_js__WEBPACK_IMPORTED_MODULE_0__.showError)(inputElement, data.fields[field]);
              }
            });
          }
          _context2.next = 15;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   clearErrorFromFields: () => (/* binding */ clearErrorFromFields),
...
var clearError = function clearError(input) {
  var errorDiv = document.getElementById("".concat(input.id, "Error"));
  if (errorDiv) {
...
var validateForm = function validateForm(form) {
  ...
  Array.from(form.elements).forEach(function (input) {
    if (input.tagName === "INPUT" || input.tagName === "TEXTAREA") {
      var _validateField = validateField(input),
        fieldIsValid = _validateField.isValid,
        errorMessage = _validateField.errorMessage;
      if (!fieldIsValid) {
        isValid = false;
...
var clearErrorFromFields = function clearErrorFromFields(form) {
  Array.from(form.elements).forEach(function (input) {
    if (input.tagName === "INPUT" || input.tagName === "TEXTAREA") {
      clearError(input);
    }
